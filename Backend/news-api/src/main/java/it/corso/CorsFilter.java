/*
 * Cos’è il filtro CORS?
 * CORS sta per Cross-Origin-Resource-Sharing e 
 * viene utilizzato nel momento in cui bisogna condividere risorse provenienti da origini diverse.
 * Viene usato per permettere al fe di fare le chiamate definite nel be.
 */
